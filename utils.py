...
def store_feeder_info_to_json(args,infos):
    ...
    feeder_info['num_of_original_buses']=len(infos['bus_list'])
    feeder_info['num_of_buses']=len(infos['updated_bus_list'])
    feeder_info['num_of_excluded_buses']=len(infos['bus_list'])-len(infos['updated_bus_list'])
