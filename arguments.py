...
class parse_args():
    ...
    def __init__(self):
        ...
        argParser.add_argument('--number-of-samples-for-each-node', default=100, type=int, help='Number of samples in each node')
        argParser.add_argument('--change-load-values', default=["yes","no"], type=str, help='whether to change the original load value')
